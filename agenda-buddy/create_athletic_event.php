...
if (isset($_POST['title'])){
    ...
    $result = mysqli_query($con, "INSERT INTO community(hash, title, start_time, end_time, year, month, day, type) VALUES('$hash', '$title', '$start_time', '$end_time', '$year', '$month', '$day', 'athletic')");
